...
@section('content')
<!-- Enhanced Hero Section for Login -->
<section class="hero login-hero">
    <div class="container">
        <div class="hero-content fade-in-up text-center">
            ...
            <p>Access your personalized learning dashboard and continue your journey with SkillCrafter.</p>
           
            <!-- Enhanced Login Stats -->
            ...
            <div class="col-md-6">
                <div class="mission-card animate-on-scroll" style="--delay: 0s">
                    <div class="card-header">
                        ...
                        <div class="mission-number">Login</div>
                    </div>
                    <div class="mission-content-inner">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mt-3 text-center">
                                <a href="{{ route('password.request') }}" class="text-decoration-none" style="color: #667eea;">Forgot Your Password?</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<style>
    ...
    /* Login Section (Using Benefits Style) */
    .login-section {
    ...
    .mission-content-inner .form-check-label {
        color: #718096;
    }
