...
@section('content')
<!-- Enhanced Hero Section for Email Verification -->
<section class="hero verification-hero">
    <div class="container">
        <div class="hero-content fade-in-up text-center">
            ...
            <p>Secure your account by verifying your email address to unlock full access to SkillCrafter.</p>
...
<!-- Enhanced Verification Form Section -->
            ...
            <div class="col-md-8">
                <div class="mission-card animate-on-scroll" style="--delay: 0s">
                    <div class="card-header">
                        ...
                        <div class="mission-number">Verify</div>
                    </div>
                    <div class="mission-content-inner text-center">
                        @if (session('resent'))
                            <div class="alert alert-success rounded-3 animate-on-scroll">
                        ...
                        <form class="d-inline animate-on-scroll" method="POST" action="{{ route('verification.resend') }}">
                            ...
                            <button type="submit" class="cta-button cta-primary">
                                <span>Request Another Verification Link</span>
